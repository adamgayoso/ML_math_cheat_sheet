...
\subsubsection{$\nabla_{\bmA}\Trace(\bmx \bmx^\top \bmA) = \bmx \bmx^\top$}
\NotDone{Proof left as an exercise for the reader.}

\subsection{Trace Relation to Determinant}
\NotDone{TBD}
